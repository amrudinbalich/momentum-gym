...
<head>
    ...
    <script>
        var tryItOutBaseUrl = "http://momentum-gym.test";
        var useCsrf = Boolean();
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-v1-products--product_sku-">Display the specified resource.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-v1-categories">Display a listing of the resource.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-categories--category_slug-">
                                <a href="#endpoints-GETapi-v1-categories--category_slug-">Display the specified resource.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-v1-brands">Display a listing of the resource.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-brands--brand_slug-">
                                <a href="#endpoints-GETapi-v1-brands--brand_slug-">Display the specified resource.</a>
                            </li>
                                ...
                                <a href="#endpoints-PUTapi-v1-products--product-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-products--product-">
                                <a href="#endpoints-DELETEapi-v1-products--product-">Remove the specified resource from storage.</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-categories">Store a newly created resource in storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-categories--category_id-">
                                <a href="#endpoints-PUTapi-v1-categories--category_id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-categories--category_id-">
                                <a href="#endpoints-DELETEapi-v1-categories--category_id-">Remove the specified resource from storage.</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-brands">Store a newly created resource in storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-brands--brand_id-">
                                <a href="#endpoints-PUTapi-v1-brands--brand_id-">Update the specified resource in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-brands--brand_id-">
                                <a href="#endpoints-DELETEapi-v1-brands--brand_id-">Remove the specified resource from storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<aside>
    <strong>Base URL</strong>: <code>http://momentum-gym.test</code>
</aside>
...
<div class="bash-example">
    ...
    --get "http://momentum-gym.test/api/user" \
...
<div class="javascript-example">
    ...
    "http://momentum-gym.test/api/user"
);
...
<div class="bash-example">
    ...
    "http://momentum-gym.test/api/login" \
    --header "Content-Type: application/json" \
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://momentum-gym.test/api/register" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"name\": \"b\",
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://momentum-gym.test/api/refresh-token" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://momentum-gym.test/api/v1/products" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://momentum-gym.test/api/v1/products"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-products--product_sku-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://momentum-gym.test/api/v1/products/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://momentum-gym.test/api/v1/products/architecto"
);
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://momentum-gym.test/api/v1/categories" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://momentum-gym.test/api/v1/categories"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-categories--category_slug-">Display the specified resource.</h2>
...
<span id="example-requests-GETapi-v1-categories--category_slug-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://momentum-gym.test/api/v1/categories/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://momentum-gym.test/api/v1/categories/1"
);
...
<span id="example-responses-GETapi-v1-categories--category_slug-">
            <blockquote>
...
<span id="execution-results-GETapi-v1-categories--category_slug-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-categories--category_slug-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-categories--category_slug-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-categories--category_slug-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-categories--category_slug-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-categories--category_slug-" data-method="GET"
      data-path="api/v1/categories/{category_slug}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-categories--category_slug-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-categories--category_slug-"
                    onclick="tryItOut('GETapi-v1-categories--category_slug-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-categories--category_slug-"
                    onclick="cancelTryOut('GETapi-v1-categories--category_slug-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-categories--category_slug-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/categories/{category_slug}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-categories--category_slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-categories--category_slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               step="any"               name="category_slug"                data-endpoint="GETapi-v1-categories--category_slug-"
               value="1"
               data-component="url">
    <br>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://momentum-gym.test/api/v1/brands" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://momentum-gym.test/api/v1/brands"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-brands--brand_slug-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://momentum-gym.test/api/v1/brands/1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://momentum-gym.test/api/v1/brands/1"
);
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-products--product-">Update the specified resource in storage.</h2>
...
<p>The product. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-products--product-">Remove the specified resource from storage.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-categories--category_id-">Update the specified resource in storage.</h2>
...
<span id="example-requests-PUTapi-v1-categories--category_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-categories--category_id-">
</span>
<span id="execution-results-PUTapi-v1-categories--category_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-categories--category_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-categories--category_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-categories--category_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-categories--category_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-categories--category_id-" data-method="PUT"
      data-path="api/v1/categories/{category_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-categories--category_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-categories--category_id-"
                    onclick="tryItOut('PUTapi-v1-categories--category_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-categories--category_id-"
                    onclick="cancelTryOut('PUTapi-v1-categories--category_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-categories--category_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-categories--category_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-categories--category_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="PUTapi-v1-categories--category_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the category. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-categories--category_id-">Remove the specified resource from storage.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-brands--brand_id-">Update the specified resource in storage.</h2>
...
<span id="example-requests-PUTapi-v1-brands--brand_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-brands--brand_id-">
</span>
<span id="execution-results-PUTapi-v1-brands--brand_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-brands--brand_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-brands--brand_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-brands--brand_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-brands--brand_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-brands--brand_id-" data-method="PUT"
      data-path="api/v1/brands/{brand_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-brands--brand_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-brands--brand_id-"
                    onclick="tryItOut('PUTapi-v1-brands--brand_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-brands--brand_id-"
                    onclick="cancelTryOut('PUTapi-v1-brands--brand_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-brands--brand_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-darkblue">PUT</small>
            <b><code>api/v1/brands/{brand_id}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-brands--brand_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-brands--brand_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="brand_id"                data-endpoint="PUTapi-v1-brands--brand_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the brand. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-brands--brand_id-">Remove the specified resource from storage.</h2>
...
<span id="example-requests-DELETEapi-v1-brands--brand_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-DELETEapi-v1-brands--brand_id-">
</span>
<span id="execution-results-DELETEapi-v1-brands--brand_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-DELETEapi-v1-brands--brand_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-DELETEapi-v1-brands--brand_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-DELETEapi-v1-brands--brand_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-DELETEapi-v1-brands--brand_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-DELETEapi-v1-brands--brand_id-" data-method="DELETE"
      data-path="api/v1/brands/{brand_id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('DELETEapi-v1-brands--brand_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-DELETEapi-v1-brands--brand_id-"
                    onclick="tryItOut('DELETEapi-v1-brands--brand_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-brands--brand_id-"
                    onclick="cancelTryOut('DELETEapi-v1-brands--brand_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-DELETEapi-v1-brands--brand_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="DELETEapi-v1-brands--brand_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="DELETEapi-v1-brands--brand_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="brand_id"                data-endpoint="DELETEapi-v1-brands--brand_id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the brand. Example: <code>1</code></p>
